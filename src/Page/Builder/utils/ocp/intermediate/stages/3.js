...
export const data = {
  title: "중급 3. 첫 번째 힌트 카드",
  image: OCP_IMAGES.intermediate.level3.cover,
  state: null,
  level: 3,
  currentStageNum: 0,
  stages: [
    // start
    {
      ...
      imgSrc: OCP_IMAGES.intermediate.level3.story
    },
    // mission 1
    {
      type: VCTYPE.STEP.IMAGE,
      imgSrc: OCP_IMAGES.intermediate.level3.mission1,
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data: "다음 단계를 진행하려면\n우측 상단에 다음단계 버튼을 눌러줘!"
      ...
      hint: [
        {
          ...
          data: OCP_IMAGES.intermediate.level3.hint1
        }
      ],
      answer: [
        { type: VCTYPE.EGO.IMAGE, data: OCP_IMAGES.intermediate.level3.answer1 }
      ],
      imgSrc: OCP_IMAGES.intermediate.level3.description1
    },
    // mission 2
    {
      type: VCTYPE.STEP.IMAGE,
      imgSrc: OCP_IMAGES.intermediate.level3.mission2,
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data: "다음 단계를 진행하려면\n우측 상단에 다음단계 버튼을 눌러줘!"
    ...
    },
    {
      ...
      hint: [
        {
          type: VCTYPE.EGO.IMAGE,
          data: OCP_IMAGES.intermediate.level3.hint2
        }
      ],
      answer: [
        { type: VCTYPE.EGO.IMAGE, data: OCP_IMAGES.intermediate.level3.answer2 }
      ],
      imgSrc: OCP_IMAGES.intermediate.level3.description2
    },

    // mission 3
    {
      type: VCTYPE.STEP.IMAGE,
      imgSrc: OCP_IMAGES.intermediate.level3.mission3,
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data: "다음 단계를 진행하려면\n우측 상단에 다음단계 버튼을 눌러줘!"
    ...
    },
    {
      ...
      hint: [
        {
          type: VCTYPE.EGO.IMAGE,
          data: OCP_IMAGES.intermediate.level3.hint3
        }
      ],
      answer: [
        { type: VCTYPE.EGO.IMAGE, data: OCP_IMAGES.intermediate.level3.answer3 }
      ],
      imgSrc: OCP_IMAGES.intermediate.level3.description3
    },
...
export const state = {
  ...
  interaction: {
    selected: {
      objects: { scene1: { name: "hint_card_a", type: "sprite" } },
      api: "ID_MOTION",
      method: null,
      scene: "scene1"
    },
