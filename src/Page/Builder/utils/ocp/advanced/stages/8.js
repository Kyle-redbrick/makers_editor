...
export const data = {
  title: "고급 8. 미사일에 맞은 로봇",
  image: OCP_IMAGES.advanced.level8.cover,
  state: null,
  level: 8,
  currentStageNum: 0,
  stages: [
    {
      ...
      imgSrc: OCP_IMAGES.advanced.level8.story,
      ego: [
        {
    ...
    },
    {
      title: "미션1",
      type: VCTYPE.STEP.IMAGE,
      imgSrc: OCP_IMAGES.advanced.level8.mission1,
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data: "다음 단계를 진행하려면\n우측 상단에 다음단계 버튼을 눌러줘!"
    ...
    },
    {
      ...
      imgSrc: OCP_IMAGES.advanced.level8.description1,
      conditions: [
        {
                  ...
                  arguments: [
                    {
                      ...
                      elements: [
                        ...
                        {
                          type: "Literal",
                          value: "effect_beam_d(2)"
                        },
                        {
                          type: "Literal",
                          value: "effect_beam_d(3)"
                        }
                      ]
                    },
                    {
      ...
      hint: [
        {
          ...
          data: OCP_IMAGES.advanced.level8.hint1
        }
      ],
      answer: [
        {
          type: VCTYPE.EGO.IMAGE,
          data: OCP_IMAGES.advanced.level8.answer1
        }
      ]
    },
    {
      title: "미션2",
      type: VCTYPE.STEP.IMAGE,
      imgSrc: OCP_IMAGES.advanced.level8.mission2,
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data: "다음 단계를 진행하려면\n우측 상단에 다음단계 버튼을 눌러줘!"
    ...
    },
    {
      title: "미션2 - 코딩",
      type: VCTYPE.STEP.CODE,
      imgSrc: OCP_IMAGES.advanced.level8.description2,
      conditions: [
        {
          type: VCTYPE.CONDITION.CODE_AST,
          sceneId: "scene2",
      ...
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data:
            "실행 버튼을 누르고 로봇이 미사일에 닿으면 말풍선을 띄우면서 왼쪽으로 이동하는지 확인해 보세요"
        }
      ],
      hint: [
        {
          type: VCTYPE.EGO.IMAGE,
          data: OCP_IMAGES.advanced.level8.hint2
        }
      ],
      answer: [
        {
          type: VCTYPE.EGO.IMAGE,
          data: OCP_IMAGES.advanced.level8.answer2
        }
      ]
    },
    {
