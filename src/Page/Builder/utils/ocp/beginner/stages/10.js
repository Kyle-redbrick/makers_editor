...
export const data = {
  title: "초급 10. 효과음 재생하기",
  state: null,
  image: OCP_IMAGES.beginner.level10.cover,
  level: 10,
  currentStageNum: 0,
  stages: [
    {
      ...
      imgSrc: OCP_IMAGES.beginner.level10.story
    },
    {
      type: StageType.IMAGE,
      imgSrc: OCP_IMAGES.beginner.level10.mission1,
      ego: [
        {
          type: EgoType.TEXT,
          data: "다음 단계를 진행하려면\n우측 상단에 다음단계 버튼을 눌러줘!"
    ...
    },
    {
      ...
      hint: [
        {
          type: EgoType.IMAGE,
          data: OCP_IMAGES.beginner.level10.hint1
        }
      ],
      answer: [
        {
          type: EgoType.IMAGE,
          data: OCP_IMAGES.beginner.level10.answer1,
          width: 480
        }
      ],
      imgSrc: OCP_IMAGES.beginner.level10.description1
    },
    {
      type: StageType.END,
      ego: [
...
export const state = {
  scene: {
    ...
    soundIds: ["effect_15", "fantasy_epic_v2", "balloons_v2"],
    timeStamp: 1583416483517
  },
  interaction: {
    selected: {
      objects: {
        scene1: { name: "frame_a", type: "background" },
