    ...
    setVelocityY(-500)
      ...
      },
      {
        title: {
          ...
          ja: "キャラクターが画面の外にはみだしましたか？次のコードを入力して画面からはみださないようにしましょう。",
          zh:
      ...
      },
      {
        title: {
          ...
          ja: "2段ジャンプをやめたい場合は、次のようにコードをしゅうせいしてください。",
    ...
    steps: [
      {
        title: {
          ...
          ja: "背景のスプライトがフレームごとに横に移動するようにコードを作成しましょう。",
          zh:
        ...
        description: {
          ...
          ja: "反対方向に動かしたい場合は、goXの値を‐３に変更してください。",
          zh:
...

  {
    ...
    steps: [
      ...
      },
      {
        title: {
          ...
          ja: "スペースを押すとミサイルのスプライトがコピーされて発射されるように、下にあるコードを作成してください。",
          zh:
    ...
    missile.onOutStage(function(){
        ...
        description: {
          ...
          ja: "goToSpriteに主人公（しゅじんこう）のスプライトの名前を入力してください。",
    ...
    steps: [
      {
        title: {
          ...
          ja: "スプライトボックスからテイストスプライトを取り出して、タイマーをスタートさせてください。",
          zh:
            "请从角色栏中取出角色，开始计时。",
          default:
            "스프라이트 박스에서 텍스트 스프라이트를 가져오고, 타이머를 시작해주세요."
      ...
      },
      {
        title: {
          ...
          ja: "フレームごとにタイマーの値を取得して、テキストプライとの内容をかえてください。",
          zh:
    ...
    setText(time)
      ...
      },
      {
        title: {
          ...
          ja: "タイマーのコンマを消したい場合は、次のコードにかえてみましょう。",
          zh:
            "想要去掉计时器的小数点，请如下修改代码。",
          default:
            "타이머의 소수점을 제거하고 싶다면 다음과 같이 코드를 변경해보세요."
  ...
  },
  {
    ...
    steps: [
      {
        title: {
          ...
          ja: "スプライトボックスからジョイスティックをえらんで、３行目のgetSpriteのnameを動かしたいスプライトの名前にかえてください。",
          zh:
    ...
    sprite.setVelocityFromDegree(degree,force,maxSpeed)
        ...
        description: {
          ...
          ja: "動く速度をかえたい場合は、maxSpeedの値の好きな数字にかえてください。",
          zh:
...

  {
    ...
    steps: [
      {
        title: {
          ...
          ja: "スプライトボックスからジョイスティックをえらんで、３行目のgetSpriteを動かしたいスプライトの名前をかえてください。",
          zh:
            "请从角色栏中取出游戏杆，将第三行getSprite的name部分改为想要操控的角色名称。",
          default:
            "스프라이트 박스에서 조이스틱을 가져오고 3번째 줄 getSprite의 name부분을 움직이고자 하는 스프라이트의 이름으로 바꿔주세요."
    ...
    sprite.setVelocityFromDegree(degree,force,maxSpeed)
        ...
        description: {
          ...
          ja: "動く速度をかえたい場合は、maxSpeedの値をかえてください。",
          zh:
            "如果想要改变移动速度，可自由修改maxSpeed的值。",
          default:
            "움직이는 속도를 변경하고 싶다면 maxSpeed의 값을 자유롭게 변경해보세요."
      ...
      },
      {
        title: {
          ...
          ja: "スプライトの確度をジョイスティックの角度の分だけかえてください。このサンプルは上をむいているので、ジョイスティックの角度に90度足してください。",
          zh:
        ...
        description: {
          ko:
            ...
            ja: "スプライトが向いている方向によって値（あたい）を変えます。",
          zh:
            "要按照角色基本面向的方向，修改要加的值。",
          default:
            "스프라이트가 기본적으로 보고있는 방향에 따라서 더하는 값이 변경되어야 합니다."
    ...
    steps: [
      {
        title: {
          ...
          ja: "X、Y軸（じく）両方向に動くように速度を設定（せってい）します。",
...
setVelocityY(500)`
      ...
      },
      {
        title: {
          ...
          ja: "X、Y軸（じく）両方向とぶつかった時に弾む（はずむ）ように設定（せってい）します。",
          zh: "请设置成碰到X轴跟Y轴时都能弹回。",
    ...
    steps: [
      {
        title: {
          ...
          ja: "ボタンをクリックすると信号が送られるようにつくります。信号の名前は自由に決めることができます。",
          zh: "点击按钮时，发送信号。",
   ...
   sendSignal("signal name")
      ...
      },
      {
        title: {
          ...
          ja: "動かしたいスプライトが信号をうけられるコードをつくります。",
    ...
    steps: [
      {
        title: {
          ...
          ja: "テキストのスプライトに次のようなコードを入力して、フレームごとにランダムな色に変わようにします。",
          zh:
    ...
    steps: [
      {
        title: {
          ...
          ja: "スプライトがフレームごとにマウスを追いかけるようにコードを作成します。",
          zh:
            "请写出角色每帧都能跟着鼠标移动的代码。",
          default:
            "스프라이트가 매 프레임마다 마우스를 따라다니게 코드를 작성합니다."
    ...
    goToMousePointer()
      ...
      },
      {
        title: {
          ...
          ja: "マウスを長押し（ながおし）、ペンがはじまるように設定（せってい）します。",
          zh: "请设置为点击鼠标时，笔就开始移动。",
    ...
    startPen()
      ...
      },
      {
        title: {
          ...
          ja: "長押し（ながおし）が終わるとペンと止まるように設定（せってい）します",
...

  {
    ...
    steps: [
      {
        title: {
          ...
          ja: "クリックするごとにサイズが大きくなるようにコードをつくります。",
    ...
    addSize(10)
        ...
        description: {
          ...
          ja: "サイズを小さくしたいときは、addSizeの値を‐（マイナス）に変更してください。",
    ...
    sendSignal("plus")
      ...
      },
      {
        title: {
          ...
          ja: "現在の数字を保存する変数をつくり、plus、minus信号を受けると変数の値を変更します。",
          zh:
