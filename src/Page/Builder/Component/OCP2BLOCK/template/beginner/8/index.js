  ...
  scene: {
    scenes: {
      scene1: {
        ...
        preview:
          "https://wizschool-images.s3.ap-northeast-2.amazonaws.com/6f9f5d4e51b5b47d8a695406f4d60dc7.jpg"
      },
      scene2: {
        sceneName: "scene2",
        sprites: {
        ...
        spriteIds: ["adventure_m", "gameover_o"],
        preview:
          "https://wizschool-images.s3.ap-northeast-2.amazonaws.com/1ffbfa24218356217bfa8a84c5d9f123.jpg"
      }
    },
    sceneIds: ["scene1", "scene2"],
    soundIds: [],
    timeStamp: 1599100258448,
    editorMode: "block"
  },
  interaction: {
    selected: {
      objects: {
        scene1: { name: "effect_beam_e", type: "sprite" },
        scene2: { name: "gameover_o", type: "sprite" }
      },
      api: "ID_PHYSICS",
      method: null,
      scene: "scene1"
