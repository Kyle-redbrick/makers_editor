      ...
      conditions: [
        {
          ...
          oobcLine: {
            blocks: [
              { blockType: "sprite", data: "energy_a" },
        ...
        },
        {
          ...
          oobcLine: {
            blocks: [
              { blockType: "sprite", data: "factory_g" },
              { blockType: "action", data: "changeScene" },
              { blockType: "constant", data: "scene3" }
            ]
          }
        },
        { type: VCTYPE.CONDITION.PLAY_ONCE },
      ...
      scene2: {
        ...
        sprites: {
          ...
          energy_a: {
            ...
            assetId: "energy_a_v2",
            code:
              '{"lines":[{"id":"30vvmy","block":{"id":"k8ew24","mode":"empty","grammars":{"sprite":"subject","variable":"subject","function":"subject","util":"subject"},"blockTypes":["sprite","variable","function","util"],"dataTypes":{"sprite":["sprite","screen","joystick","text","sound"],"variable":["sprite","function"],"function":["function"],"util":["util","mobile"]}},"folded":false,"disabled":false}],"focusedLineIndex":-1,"focusedBlockIndex":-1,"editingBlockIndex":-1,"focusedCategory":null}',
            preview: {
              name: "energy_a",
              type: "sprite",
              subtype: null,
        ...
        spriteIds: ["factory_g", "energy_a", "boy_d", "plent_l", "button_ab_a"],
        preview:
          "https://wizschool-images.s3.ap-northeast-2.amazonaws.com/09aa48e008dc532e737142497ac14159.jpg"
      },
      scene3: {
        sceneName: "scene3",
        sprites: {
