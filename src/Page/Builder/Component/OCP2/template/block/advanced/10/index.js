  ...
  stages: [
      ...
      conditions: [
        {
          ...
          oobcLine: {
            blocks: [
              { blockType: "sprite", data: "funky" },
              { blockType: "action", data: "play" }
            ]
          }
        },
        { type: VCTYPE.CONDITION.PLAY_ONCE },
        {
          ...
          event: { api: "playSound", name: "funky" }
        }
      ],
      ego: [
        {
    ...
    },
    {
      ...
      conditions: [
        ...
        {
          type: VCTYPE.CONDITION.GAME_EVENT,
          event: { api: "playSound", name: "fail_3" }
        }
      ],
      ego: [
        {
  ...
  scene: {
    scenes: {
      scene1: {
        ...
        preview:
          "https://wizschool-images.s3.ap-northeast-2.amazonaws.com/de529ea5c03c617befb4bd4811669fe9.jpg"
      },
      scene2: {
        sceneName: "scene2",
        sprites: {
        ...
        preview:
          "https://wizschool-images.s3.ap-northeast-2.amazonaws.com/a8d6d17f3daa091c231a0ef6adea901b.jpg"
      },
      scene3: {
        sceneName: "scene3",
        sprites: {
          ...
          retry_l: {
            ...
            assetId: "retry_l",
            code:
              '{"lines":[{"id":"ofpilp","block":{"id":"1ibn1n","mode":"instance","grammars":{"sprite":"subject","variable":"subject","function":"subject","util":"subject"},"grammar":"subject","blockTypes":["sprite","variable","function","util"],"blockType":"sprite","dataTypes":{"sprite":["sprite","screen","joystick","text","sound"],"variable":["sprite","function"],"function":["function"],"util":["util","mobile"]},"dataType":"sprite","data":"retry_l","childs":[{"id":"tc20bp","mode":"instance","grammars":{"property":"subject","util":"subject","action":"verb"},"grammar":"verb","blockTypes":["property","action","util"],"blockType":"action","parentDataTypes":["sprite","text"],"dataTypes":{"property":["number","string","boolean"],"action":["sprite"],"util":["sprite"]},"dataType":"sprite","data":"onTouch","childs":[{"id":"cb33ad","mode":"instance","grammars":{"callback":"objective"},"grammar":"objective","blockTypes":["callback"],"blockType":"callback","dataTypes":{"callback":[null]},"data":[{"id":"u18h7k","block":{"id":"kjf7xn","mode":"instance","grammars":{"sprite":"subject","variable":"subject","function":"subject","util":"subject"},"grammar":"subject","blockTypes":["sprite","variable","function","util"],"blockType":"sprite","dataTypes":{"sprite":["sprite","screen","joystick","text","sound"],"variable":["sprite","function"],"function":["function"],"util":["util","mobile"]},"dataType":"screen","data":"factory_i","childs":[{"id":"wan1ld","mode":"instance","grammars":{"property":"subject","util":"subject","action":"verb"},"grammar":"verb","blockTypes":["property","action","util"],"blockType":"action","parentDataTypes":["screen"],"dataTypes":{"property":["number","string","boolean"],"action":["screen"],"util":["sprite"]},"dataType":"screen","data":"changeScene","childs":[{"id":"sy896i","mode":"instance","grammars":{"constant":"objective","operator":"objective"},"grammar":"objective","blockTypes":["constant","operator"],"blockType":"constant","dataTypes":{"constant":["screen"],"operator":["screen"]},"dataType":"screen","data":"scene1","childs":[]}]}]},"folded":false,"disabled":false},{"id":"cwhv7n","block":{"id":"xxesfx","mode":"empty","grammars":{"sprite":"subject","variable":"subject","function":"subject","util":"subject"},"blockTypes":["sprite","variable","function","util"],"dataTypes":{"sprite":["sprite","screen","joystick","text","sound"],"variable":["sprite","function"],"function":["function"],"util":["util","mobile"]}},"folded":false,"disabled":false}]}]}]},"folded":false,"disabled":false},{"id":"583wo7","block":{"id":"iu2za1","mode":"empty","grammars":{"sprite":"subject","variable":"subject","function":"subject","util":"subject"},"blockTypes":["sprite","variable","function","util"],"dataTypes":{"sprite":["sprite","screen","joystick","text","sound"],"variable":["sprite","function"],"function":["function"],"util":["util","mobile"]}},"folded":false,"disabled":false}]}',
            preview: {
              name: "retry_l",
              type: "sprite",
              subtype: null,
        ...
        preview:
          "https://wizschool-images.s3.ap-northeast-2.amazonaws.com/1fef6b3ceec45ca425d21b6f50fadf0a.jpg"
      }
    },
    sceneIds: ["scene1", "scene2", "scene3"],
    soundIds: ["funky_v2", "fail_3"],
    timeStamp: 1602569568283,
    editorMode: "block"
  },
  interaction: {
    selected: {
