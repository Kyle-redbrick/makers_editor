    ...
    },
    {
      ...
      conditions: [
        ...
        { type: VCTYPE.CONDITION.PLAY_ONCE },
        {
          ...
          event: { api: "setVelocityX", spriteId: "plent_l", value: 300 }
        }
      ],
      ego: [
        {
      ...
      conditions: [
        {
          ...
          oobcLine: {
            blocks: [
              ...
              { blockType: "sprite", data: "factory_g" }
            ]
          }
        },
        {
          ...
          oobcLine: {
            blocks: [
              { blockType: "sprite", data: "plent_l" },
              { blockType: "property", data: "bounceX" },
              { blockType: "action", data: "set" },
        ...
        {
          type: VCTYPE.CONDITION.GAME_EVENT,
          event: { api: "setBounceX", spriteId: "plent_l", value: 1 }
        }
      ],
      ego: [
        {
  ...
  scene: {
    scenes: {
      scene1: {
        ...
        preview:
          "https://wizschool-images.s3.ap-northeast-2.amazonaws.com/a365ae9786cc48422021da42ac609404.jpg"
      },
      scene2: {
        sceneName: "scene2",
        sprites: {
        ...
        preview:
          "https://wizschool-images.s3.ap-northeast-2.amazonaws.com/7eb7310d85010fdde4abec1ee116b485.jpg"
      }
    },
    sceneIds: ["scene2", "scene1"],
    soundIds: ["funky_v2", "victory_1"],
    timeStamp: 1602568884642,
    editorMode: "block"
  },
  interaction: {
    selected: {
