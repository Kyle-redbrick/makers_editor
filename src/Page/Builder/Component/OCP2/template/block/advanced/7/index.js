      ...
      conditions: [
        {
          ...
          oobcLine: {
            blocks: [
              { blockType: "sprite", data: "button_ab_a" },
        ...
        { type: VCTYPE.CONDITION.PLAY_ONCE },
        {
          ...
          event: { api: "onClick", spriteId: "button_ab_a" }
        },
        {
          type: VCTYPE.CONDITION.GAME_EVENT,
          event: { api: "setVelocityY", spriteId: "boy_d", value: -1000 }
        }
      ],
      ego: [
        {
      ...
      scene2: {
        ...
        sprites: {
          ...
          button_ab_a: {
            ...
            code:
              '{"lines":[{"id":"pvyyhc","block":{"id":"7tc8dj","mode":"empty","grammars":{"sprite":"subject","variable":"subject","function":"subject","util":"subject"},"blockTypes":["sprite","variable","function","util"],"dataTypes":{"sprite":["sprite","screen","joystick","text","sound"],"variable":["sprite","function"],"function":["function"],"util":["util","mobile"]}},"folded":false,"disabled":false}]}',
            preview: {
              name: "button_ab_a",
              type: "sprite",
              subtype: null,
        ...
        preview:
          "https://wizschool-images.s3.ap-northeast-2.amazonaws.com/21ee69f6fe25e885b54816ab0dbf6a00.jpg"
      }
    },
    sceneIds: ["scene2", "scene1"],
    soundIds: ["funky_v2", "victory_1"],
    timeStamp: 1602568920178,
    editorMode: "block"
  },
  interaction: {
    selected: {
