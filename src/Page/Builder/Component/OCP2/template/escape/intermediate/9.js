...
export const data = {
  title: "중급 9. 금고를 열어라",
  image: OCP_IMAGES.intermediate.level9.cover,
  state: null,
  level: 9,
  currentStageNum: 0,
  stages: [
    // start
    {
      ...
      imgSrc: OCP_IMAGES.intermediate.level9.story
    },
    // mission 1
    {
      type: VCTYPE.STEP.IMAGE,
      imgSrc: OCP_IMAGES.intermediate.level9.mission1,
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data: "다음 단계를 진행하려면\n우측 상단에 다음단계 버튼을 눌러줘!"
      ...
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data:
            "실행 버튼을 누르고 금고의 비밀번호를 알맞게 입력했을 때 금고가 열린 모양으로 바뀌는지 확인해 보세요"
        }
      ],
      hint: [
        {
          type: VCTYPE.EGO.IMAGE,
          data: OCP_IMAGES.intermediate.level9.hint1
        }
      ],
      answer: [
        { type: VCTYPE.EGO.IMAGE, data: OCP_IMAGES.intermediate.level9.answer1 }
      ],
      imgSrc: OCP_IMAGES.intermediate.level9.description1
    },
    // mission 2
    {
      type: VCTYPE.STEP.IMAGE,
      imgSrc: OCP_IMAGES.intermediate.level9.mission2,
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data: "다음 단계를 진행하려면\n우측 상단에 다음단계 버튼을 눌러줘!"
      ...
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data:
            "실행 버튼을 누르고 금고의 비밀번호를 알맞게 입력했을 때 금고가 열린 후 1초 뒤에 성공 장면으로 바뀌는지 확인해 보세요"
        }
      ],
      hint: [
        {
          type: VCTYPE.EGO.IMAGE,
          data: OCP_IMAGES.intermediate.level9.hint2
        }
      ],
      answer: [
        { type: VCTYPE.EGO.IMAGE, data: OCP_IMAGES.intermediate.level9.answer2 }
      ],
      imgSrc: OCP_IMAGES.intermediate.level9.description2
    },
    // mission 3
    {
      type: VCTYPE.STEP.IMAGE,
      imgSrc: OCP_IMAGES.intermediate.level9.mission3,
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data: "다음 단계를 진행하려면\n우측 상단에 다음단계 버튼을 눌러줘!"
      ...
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data:
            "실행 버튼을 누르고 금고를 클릭한 다음, 틀린 비밀번호를 입력했을 때 화면이 흔들리는지 확인해 보세요"
        }
      ],
      hint: [
        {
          type: VCTYPE.EGO.IMAGE,
          data: OCP_IMAGES.intermediate.level9.hint3
        }
      ],
      answer: [
        { type: VCTYPE.EGO.IMAGE, data: OCP_IMAGES.intermediate.level9.answer3 }
      ],
      imgSrc: OCP_IMAGES.intermediate.level9.description3
    },
    // end
    {
      type: VCTYPE.STEP.IMAGE,
...
export const state = {
  ...
  interaction: {
    selected: {
      objects: {
        scene1: { name: "safe_a", type: "sprite" },
        scene2: {
          name: "hint_card_b",
          type: "sprite"
        },
