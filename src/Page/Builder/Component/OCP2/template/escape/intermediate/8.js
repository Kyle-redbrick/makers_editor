...
export const data = {
  title: "중급 8. 금고의 비밀번호",
  image: OCP_IMAGES.intermediate.level8.cover,
  state: null,
  level: 8,
  currentStageNum: 0,
  stages: [
    // start
    {
      ...
      imgSrc: OCP_IMAGES.intermediate.level8.story
    },
    // mission 1
    {
      type: VCTYPE.STEP.IMAGE,
      imgSrc: OCP_IMAGES.intermediate.level8.mission1,
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data: "다음 단계를 진행하려면\n우측 상단에 다음단계 버튼을 눌러줘!"
      ...
      ego: [
        {
          type: VCTYPE.EGO.TEXT,
          data:
            "실행 버튼을 누르고 금고를 클릭하면 비밀번호를 입력하는 창이 뜨는지 확인해 보세요"
        }
      ],
      hint: [
        {
          type: VCTYPE.EGO.IMAGE,
          data: OCP_IMAGES.intermediate.level8.hint1
        }
      ],
      answer: [
        { type: VCTYPE.EGO.IMAGE, data: OCP_IMAGES.intermediate.level8.answer1 }
      ],
      imgSrc: OCP_IMAGES.intermediate.level8.description1
    },
    // end
    {
      type: VCTYPE.STEP.IMAGE,
