  ...
  return (
    <div className="information">
      ...
      <div className="information__slide-box">
        <button type="button" className={isActive.info1 ? "information__slide-title active" : "information__slide-title"} onClick={() => toggleSlideBox("info1")}>
          <FormattedMessage id="ID_ABOUT_INFORMATION_TECHNICAL" />
          <img alt="슬라이드 아이콘" src={SlideArrowIcon} />
        </button>

        <div className={isActive.info1 ? "information__slide-inner-wrap information__slide-inner-wrap--technical show" : "information__slide-inner-wrap information__slide-inner-wrap--technical"}>
      ...
      <div className="information__slide-box">
        <button type="button" className={isActive.info2 ? "information__slide-title active" : "information__slide-title"} onClick={() => toggleSlideBox("info2")}>
          <FormattedMessage id="ID_ABOUT_INFORMATION_PROFILE" />
          <img alt="슬라이드 아이콘" src={SlideArrowIcon} />
        </button>

        <div className={isActive.info2 ? "information__slide-inner-wrap information__slide-inner-wrap--profile show" : "information__slide-inner-wrap information__slide-inner-wrap--profile"}>
          <div className="information__slide-inner-content">
