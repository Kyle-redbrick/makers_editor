...
const Lecture = memo(({ course, ...props }) => {
  ...
  return (
    <Self>
      <Header>
        <Thumbnail className={!course.course.unlocked && "lock"} image={URL.S3_DREAMCLASS + course.course.smallPosterURL} />
        <TitleWrap>
        ...
        <ButtonWrap>
          ...
          <Dropdown type="button" onClick={handleClickToggle}>
            <DropdownIcon alt="프로젝트 펼쳐보기" src={show ? IMAGE.ARROW_UP : IMAGE.ARROW_DOWN} />
          </Dropdown>
        </ButtonWrap>
      </Header>
