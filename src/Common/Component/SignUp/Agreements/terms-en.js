export default `### **MANGOSTEEMS PTE. LTD. Terms of Use Agreement**

**Article 1 (Purpose)**

This Agreement aims to stipulate the rights, obligations, and responsibilities of mangoSTEEMS and its users in relation to the use of services and various services provided by mangoSTEEMS Co., Ltd.

**Article 2 (Definition)**

The definitions of terms used in these terms and conditions are as follows. 
The term "user" refers to members and non-members who access the site of "astro-coding-go.com" and use all the services provided by "astro-coding-go.com" under these terms and conditions. 
...
"Service" refers to services and online/offline services that "astro-coding-go.com" provides to "users" electronically, including programming training platforms provided by "astro-coding-go.com." "Service" is a concept that includes "content" provided by "astro-coding-go.com," and in some cases, it is marked as "service and content" in this contract. 
...
MANGOSTEEMS PTE. LTD. (hereinafter referred to as "Company") posts the contents of the terms and conditions, the name of the representative, the address of the office, the phone number, the copy transmission number, e-mail address, business registration number, and the personal information management officer. 
However, the terms and conditions can be viewed through the connection screen. 
...
If the "company" clearly notifies or notifies the member of the revised terms and conditions and does not express its intention within 30 days, it is deemed that the member has agreed to the revised terms and conditions. 
If the "member" disagrees with the application of the revised terms and conditions, the company cannot apply the revised terms and conditions, and in this case, the member may terminate the contract of use. 
However, if there are special circumstances in which the existing terms and conditions cannot be applied, the company may terminate the contract.
...
However, the "company" may not accept any of the following applications or terminate the contract afterwards. 
Exceptions shall be made in cases where the applicant for membership has previously lost his/her membership under these terms and conditions, but has obtained consent to re-subscribe as a member of the "company". 
...
"Member" can view and modify one's personal information at any time through the personal information management screen. 
However, the "ID" required for service management cannot be modified. 
...
The "ID" and "password" of "member" are responsible for the management of "ID" and "password" of "member" "Company" may restrict the use of "ID" if the "ID" of "members" is feared to leak personal information, violate antisocial or aesthetic customs, or may be mistaken as the operator of "company" and "company". 
...
"Company" shall deal with any opinions or complaints raised by "members" regarding the use of the service if deemed justifiable. 
For opinions or complaints raised by "members," use the bulletin board or deliver the process and results to "members" through e-mail.

**Article 11 (the obligation of "members")**

"members" shall not do the following: Registration of false information upon application or change. 
Use information from others. Change of information posted by "Company". 
Transmission or posting of information (computer programs, etc.) other than information prescribed by "Company" Infringement of intellectual property rights such as copyrights of "company" and other third parties. 
An act of damaging the reputation of the "company" and other third parties or interfering with business. 
The act of disclosing or posting obscene or violent messages, images, voices, and other information contrary to public order in "services" The act of using "service" for profit without the consent of the company. 
Other illegal or unfair acts. "Member" shall comply with the relevant laws, the provisions of these terms and conditions, the usage policy, the instructions for use, and the precautions notified by "Company" and shall not interfere with other "Company" business.

**Article 12 (Providing Services, etc.)**

The company provides the following services to its members. 
Programming education service. Programming authoring platform. Programming work sharing platform. 
A community related to programming education. All other services provided to "members" through additional development by "company" or partnership contracts with other companies. 
The company may divide the "service" into a certain range and designate a separate available time for each range. 
However, in this case, the contents are notified in advance. In principle, "service" is provided 24 hours a day, 24/7. 
"Company" may temporarily suspend the provision of "service" if there are significant reasons for maintenance inspection, replacement and failure of information and communication facilities such as computers, communication failure, or operation. In this case, "Company" notifies "Member". However, if there is an unavoidable reason why the "company" cannot notify in advance, it may be notified afterwards. The "company" may conduct regular inspections if necessary for the provision of services, and the regular inspection time shall be in accordance with the notice made in the Service Republic of Korea.
...
"Company" may provide "Member" with various information deemed necessary during the use of "Service" to "Member" through announcements or e-mail. 
However, "members" may refuse to receive e-mail at any time, except for transaction-related information and customer inquiries under the relevant laws. 
...
However, it is excluded from "members"'s reply to transaction-related information and customer inquiries. 
"Company" can post advertisements on the service screen, homepage, and e-mail in connection with the operation of "Service". 
Upon receiving the e-mail with the advertisement posted, the "member" may refuse to receive it to the "company". 
"Users (including members, non-members)" do not take measures such as changing, modifying, or restricting posts or other information in relation to services provided by the company.
...
When I release my post (work), I allow someone else to modify my post (work). 
(Including the production of the second work) Posts posted by "members" within "services" may be exposed to search results, "services" and related promotions, and may be partially modified, reproduced, edited and posted within the scope necessary for such exposure. 
In this case, the company complies with the copyright law regulations, and "members" may take measures such as deletion or non-disclosure of the post at any time through the customer center or the management function within the "service". If the "company" intends to use the "post" of "members" in a way other than paragraph (2), it must obtain consent from the "members" in advance through telephone, fax, e-mail, etc.
...
However, "posts" of "members" and works provided under the partnership contract are excluded. In relation to the service, "Company" only grants "members the right to use accounts, contents, etc. according to the terms of use set by "Company", and "members" cannot transfer, sell, or provide collateral.
...
If "members" terminate the contract, all posts registered in their accounts, such as projects, among "posts" created by "members" will be deleted. 
However, "posts" registered on the public bulletin board and re-posted by sharing will not be deleted, so please delete them directly or delete them from the "company" in advance. 
...
"Member" may file an objection to restrictions on use under this Article in accordance with the procedures set by "Company".
At this time, if the "company" admits that the objection is justified, the "company" immediately resumes the use of the "service".
...
"Company" is not responsible for the information, data, reliability of facts, accuracy, etc. posted by "Member" in relation to "Service". "Company" is exempt from liability if it makes transactions between "members" or between "members" and third parties through "services". 
...
Litigation regarding disputes between "company" and "members" shall be governed by the address of the "members" at the time of filing, and if there is no address, it shall be under the exclusive jurisdiction of the district court having jurisdiction over the residence. 
...
**Article 25 (Special Regulations on Contracts for Minor Use)**

"Company" shall take measures to notify minors themselves or legal representatives before signing the contract that if minors under the age of 20 want to use paid services, they can cancel the contract if they do not obtain consent or approval after signing the contract.

**Article 26 (Reception Confirmation Notice, Change and Cancellation of Application for Use)**

mangoSTEEMS notifies "User" of receipt confirmation if there is an application for use by "User". 
...
**Article 27 (mangoSTEEMS's obligation)**
...
"Company" shall handle any opinions or complaints raised by "users" regarding the use of "content" and "service" without delay. 
...
Payments made by mangoSTEEMS through points paid by mangoSTEEMS, such as prepaid cards, debit cards, credit cards, and other credit cards, or payment by phone or mobile phone recognized by mangoSTEEMS.
...
In this case, the "company" notifies the "user" in the manner specified in Article 9[Notification of Members]. 
However, if there is an unavoidable reason why the "company" cannot notify in advance, it may be notified afterwards. 
The "company" compensates the "user" for damages caused by the temporary suspension of the provision of paid content or paid services for no considerable reason. 
However, this is not the case if the "company" proves that there is no intention or negligence. "Company" may conduct regular inspections if necessary for the provision of paid content or paid services, and the regular inspection time shall be as notified in the Service Republican-myeon. 
...
In the case of paragraph (2), if the changes are significant or unfavorable to the "user", the "company" shall notify the "user" who is provided with the relevant paid content and paid services in the manner specified in Article 9 ("members" and obtain consent. 
At this time, the "company" provides content or service before the change to the "user" who refuses to consent. However, if such content or service cannot be provided, the paid service provision contract may be terminated. "Company" compensates for damages suffered by "user" due to the termination of the contract under paragraph (3) for changes in paid content or paid services under paragraph (1).

**Article 32 (Providing Information and Publishing Advertisements)**

"Company" may provide "Member" with various information deemed necessary by "User" during the use of content or services through notices or e-mails. 
However, "members" can refuse receipt at any time through e-mail. 
If you intend to transmit the information under paragraph (1) by phone or mother-in-law transmitter, send it with the prior consent of the "member". "Company" can post advertisements on content or service screens, homepages, e-mails, etc. in connection with the provision of "content" services. A "member" who receives an e-mail with an advertisement may refuse to receive it to the "company".

**Article 33 (Delete Post)**
"Company" shall delete harmful media for youth in violation of the Act on Promotion of Information and Communication Network Utilization and Information Protection without delay. 
However, exceptions are made to bulletin boards that can only be used by "users" aged 19 or older. 
...
The paid contents and paid services of "Company" are divided into products that can be withdrawn and products that are restricted from withdrawing subscription, and these contents are notified on the transaction screen when "users" purchase paid content and paid services. Users who have signed a contract with "Company" on the use of paid content and paid services that can be withdrawn can withdraw their subscription within seven days from the date of purchase or the date of availability of paid content and paid services. The "user" may not withdraw subscription pursuant to paragraph (1) against the will of the company in any of the following cases. However, if the company does not take measures pursuant to paragraph (3), the subscription may be withdrawn even if it falls under the provisions of subparagraphs 2 through 5. If goods, etc., are lost or damaged due to reasons responsible to the "user", if the "user" uses or consumes goods, it is difficult to resell them over time, or if digital content under Article 2 Subparagraph 5 of the Framework Act on Cultural Industry is initiated (but not provided). Measures should be taken to ensure that the exercise of rights, such as withdrawal of subscription, is not disturbed by clearly specifying where possible or providing test-use products. However, if a "user" is unable to withdraw subscription, etc. for digital content in paragraph (2) 5, the exercise of rights, such as withdrawal of subscription, shall not be disturbed by providing trial products as prescribed by Presidential Decree. If the "company" fails to take such measures, the "user" may withdraw the subscription despite the reasons for restriction on withdrawal of subscription under paragraph (2) 2 through 5. Notwithstanding the provisions of paragraphs (1) to (3), "Users" may withdraw their subscription within three months from the date of purchase or the date of availability of paid content and paid service if the contents of paid content and paid service are different from the contract. "Users" may withdraw their subscription verbally, in writing (including electronic documents), or by e-mail.

**Article 36-2 (withdrawal of subscription to a paid content use contract attributable to the "company")**
"User" may terminate or terminate the content use contract within three months from the date of supply or 30 days from the date of knowing the fact. If the "content" agreed in the usage contract is not provided, the "content" provided is different from or significantly different from display and advertisement, or if it is significantly impossible to use normally due to other "content" defects, "user" may withdraw subscription by oral or written (including electronic documents) or e-mail. "Company" shall, without delay, reply to "User" after receiving an expression of intention to withdraw or terminate the subscription indicated by "User" pursuant to paragraph (3). The "user" may request complete "content" or cure for defects in service use for a considerable period of PTEtime before expressing his intention to terminate or terminate the contract for the reasons under paragraph (2).

**Article 37 (the effect of withdrawal of subscription and cancellation or termination of a contract)**

The "company" shall refund the payment in the same way as the payment within three business days from the date the "user" expresses his intention to withdraw the subscription or within three business days from the date of replying to the termination or termination of the contract, and shall notify in advance. In this case, when the "company" delays the refund to the "user", the delayed interest calculated by multiplying the delayed interest rate determined and notified by the Fair Trade Commission shall be paid for the delayed period. If the "company" refunds pursuant to paragraph (1), the "user" may deduct and refund the amount equivalent to the profits from the use of paid content and paid services. In refunding the above payment, "Company" requests the business operator who provided the payment method to suspend or cancel the claim for goods, etc. without delay when "user" pays for goods, etc. by payment method such as credit card or electronic money. However, this may not be the case if the amount deduction under paragraph (2) is necessary. If "company," "person who has been paid for content, etc." or "person who has signed a content use contract with the user" are not the same person, each is jointly responsible for the fulfillment of obligations related to subscription withdrawal, contract cancellation, or termination. The "company" shall not claim a penalty or compensation for damages from the "user" on the grounds of withdrawal of subscription permitted by these terms and conditions and related laws. However, it does not affect the "user"'s claim for damages to be terminated or terminated.

**Article 38 (overpayment)**
n the event of an overpayment , the "company" shall refund the entire amount of the error in the same way as the payment of the usage amount. However, if it is impossible to refund in the same way, we will notify you in advance. In the event of an overpayment due to responsible reasons for the "company", the "company" will refund the full amount of the overpayment regardless of the contract cost or fee. However, in the event of an overpayment due to responsible reasons for the "user", the "user" shall bear the expenses incurred for the "company" to refund the overpayment within a reasonable range. "Company" is responsible for proving that the usage fee has been duly charged in the event of refusal to refund the overpayment claimed by "user". The "company" handles the refund procedure for overpayment in accordance with the digital content user protection guidelines.
...
f the "company" is unable to provide "content" and "service" due to natural disasters or equivalent force majeure, the "company" is exempted from liability for providing "content" and "service". "Company" shall not be liable for obstacles in the use of "content" and "service" due to reasons attributable to "user". "Company" is not responsible for the information, data, reliability of facts, accuracy, etc. posted by "members" in relation to "content". "Company" shall not be liable for disputes arising from "content" and "service" between "users" or between "users" and third parties.

**Article 41 (Resolution of Dispute)**
“In the event of a dispute, the "company" takes appropriate and prompt action by reflecting the legitimate opinions or complaints raised by the "user." However, if it is difficult to expedite the process, the "company" notifies the "user" of the reason and processing schedule.

**Article 42 (Applicable Law and competent court)**
Litigation filed between "company" and "user" shall be governed by Korean law. A lawsuit regarding a dispute between the "company" and the "user" shall be governed by the address of the "user" at the time of filing, and if there is no address, it shall be under the exclusive jurisdiction of the district court having jurisdiction over the residence. However, if the address or residence of the "user" is not clear at the time of filing, the competent court shall determine in accordance with the Civil Procedure Act. In the case of "users" with addresses or residences abroad, the Seoul Central District Court of Korea shall be the competent court for disputes between "company" and "users" despite the preceding paragraph.

**Article 43 (Other provisions)**
Members may not transfer the rights and obligations under these terms and conditions to a third party without prior written consent from the other party. Contracts, agreements, notifications, changes in the company's policies, enactments and revisions of laws, or notices and guidelines by public institutions, etc., additionally prepared by agreement between the parties, form part of these terms and conditions.

These terms and conditions will take effect on January 1, 2019. mangoSTEEMS PTE. LTD.
`;
